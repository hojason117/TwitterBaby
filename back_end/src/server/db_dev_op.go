...
func dbReinsert() {
	h := handler.NewHandler("mongodb://hojason117:cen5035se@ds139921.mlab.com:39921/twitterbaby")
...
func reconstructTestDB() {
	h := handler.NewHandler("mongodb://hojason117:cen5035se@ds239911.mlab.com:39911/twitterbaby_test")
